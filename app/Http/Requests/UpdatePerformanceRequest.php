...
/**
 * Form request for updating existing performance data.
 *
...
class UpdatePerformanceRequest extends FormRequest
{
    ...
    public function authorize(): bool
    {
        ...
        return $this->user()->can('update', $performance);
    }
    ...
    public function rules(): array
    {
        ...
        return [
            'homestay_id' => ['sometimes', 'required', 'integer', Rule::exists('homestays', 'id')],
            'bulan' => ['sometimes', 'required', 'integer', 'between:1,12', new ValidMonthYear('month')],
            'tahun' => ['sometimes', 'required', 'integer', 'min:2000', new ValidMonthYear('year')],
            'pelawat_domestik' => ['sometimes', 'required', 'integer', 'min:0', 'max:999999'],
            'pelawat_asing' => ['sometimes', 'required', 'integer', 'min:0', 'max:999999'],
            'pendapatan' => ['sometimes', 'required', 'numeric', 'min:0', 'max:9999999999.99'],
            'sumber_lain' => ['sometimes', 'required', 'numeric', 'min:0', 'max:9999999999.99'],
            'homestay_id_check' => [new UniquePerformancePerMonth($performance->id)],
        ];
    }
