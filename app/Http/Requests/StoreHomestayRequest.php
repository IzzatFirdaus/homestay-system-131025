...
/**
 * Form request for storing a new homestay.
 *
 * Validates all required fields and business rules for creating a homestay.
 *
...
class StoreHomestayRequest extends FormRequest
{
    ...
    {
        return $this->user()->can('create', Homestay::class);
    }
    ...
    public function rules(): array
    {
        return [
            ...
            'kapasiti' => ['required', 'integer', 'min:1', 'max:1000'],
            'fasiliti' => ['nullable', 'string', 'max:5000'],
            'model_pengurusan' => ['required', 'string', Rule::in(['koperasi', 'individu'])],
            'id_koperasi' => [
                'nullable',
                'integer',
