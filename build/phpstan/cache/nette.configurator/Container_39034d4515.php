...
class Container_39034d4515 extends _PHPStan_6597ef616\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService0359(): PHPStan\File\FileExcluderRawFactory
	{
		return new class ($this) implements PHPStan\File\FileExcluderRawFactory {
			...
			public function __construct(Container_39034d4515 $container)
			{
	...
	public function createServiceContainer(): Container_39034d4515
	{
		return $this;
	}
