...
class Container_1932047378 extends _PHPStan_6597ef616\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService0359(): PHPStan\File\FileExcluderRawFactory
	{
		return new class ($this) implements PHPStan\File\FileExcluderRawFactory {
			...
			public function __construct(Container_1932047378 $container)
			{
	...
	public function createServiceContainer(): Container_1932047378
	{
		return $this;
	}
	...
	protected function getStaticParameters(): array
	{
		return [
			...
			'env' => [
				...
				'CHROME_CRASHPAD_PIPE_NAME' => '\\\.\pipe\crashpad_21412_SIHQCCBGTIWSZXAS',
				'COLUMNS' => '245',
				...
				'LANG' => 'en_US.UTF-8',
				'COLORTERM' => 'truecolor',
				'CLAUDE_CODE_SSE_PORT' => '24541',
				'ENABLE_IDE_INTEGRATION' => 'true',
				'GEMINI_CLI_IDE_SERVER_PORT' => '51895',
