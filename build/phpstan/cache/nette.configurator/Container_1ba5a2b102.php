...
class Container_1ba5a2b102 extends _PHPStan_6597ef616\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService0359(): PHPStan\File\FileExcluderRawFactory
	{
		return new class ($this) implements PHPStan\File\FileExcluderRawFactory {
			...
			public function __construct(Container_1ba5a2b102 $container)
			{
	...
	public function createServiceContainer(): Container_1ba5a2b102
	{
		return $this;
	}
