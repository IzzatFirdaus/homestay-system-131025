...
@section('title', __('Kemaskini Prestasi'))

@section('content')
    <div class="container-fluid px-4">
        <x-card>
            <div class="card-header">
                <h5 class="mb-0">{{ __('Kemaskini Rekod Prestasi') }}</h5>
                <p class="text-muted small mb-0">{{ $performance->homestay->nama }}</p>
            </div>
            <div class="card-body">
                            ...
                            <div class="mb-3">
                                ...
                                >
                                    @foreach($homestays as $id => $nama)
                                        <option value="{{ $id }}" {{ old('homestay_id', $performance->homestay_id) == $id ? 'selected' : '' }}>
                                            {{ $nama }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="mb-3">
                                ...
                                >
                                    @foreach(['Januari', 'Februari', 'Mac', 'April', 'Mei', 'Jun', 'Julai', 'Ogos', 'September', 'Oktober', 'November', 'Disember'] as $index => $month)
                                        <option value="{{ $index + 1 }}" {{ old('bulan', $performance->bulan) == ($index + 1) ? 'selected' : '' }}>
                                            {{ $month }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="mb-3">
                                ...
                                >
                                    @foreach($yearRange as $year)
                                        <option value="{{ $year }}" {{ old('tahun', $performance->tahun) == $year ? 'selected' : '' }}>
                                            {{ $year }}
                                        </option>
                                    @endforeach
                                </select>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input
                                    ...
                                    value="{{ old('pelawat_domestik', $performance->pelawat_domestik) }}"
                                    min="0"
                                    required
                                >
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input
                                    ...
                                    value="{{ old('pelawat_asing', $performance->pelawat_asing) }}"
                                    min="0"
                                    required
                                >
                                @error('pelawat_asing')
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input
                                    ...
                                    value="{{ old('pendapatan', $performance->pendapatan) }}"
                                    min="0"
                                    step="0.01"
                                    required
                                >
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input
                                    ...
                                    value="{{ old('sumber_lain', $performance->sumber_lain ?? 0) }}"
                                    min="0"
                                    step="0.01"
                                >
                                @error('sumber_lain')
